...
def test_ner_ent():
    ...
    assert (
        text_ent["PERSON"][0][-1] == "John Doe"
        and text_ent["DATE"][0][-1] == "12/12/1990"
    )
...
def test_regex_match():
    ...
    print(match_dict)
    assert (
        match_dict["PERSON"][0][-1] == "hari.golamari"
        and match_dict["PHONE"][0][-1] == "8333087809"
        and match_dict["DATE"][0][-1] == "12/12/1990 t"
    )
